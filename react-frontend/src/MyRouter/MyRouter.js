...
import SingleIntakesPage from "../components/app_components/IntakesPage/SingleIntakesPage";
import IntakeProjectLayoutPage from "../components/app_components/IntakesPage/IntakeProjectLayoutPage";
...
import SingleProgrammePage from "../components/app_components/ProgrammePage/SingleProgrammePage";
import ProgrammeProjectLayoutPage from "../components/app_components/ProgrammePage/ProgrammeProjectLayoutPage";
...
<Route path="/intakes/:singleIntakesId" exact element={<SingleIntakesPage />} />
<Route path="/intakes" exact element={<IntakeProjectLayoutPage />} />
...
<Route path="/programme/:singleProgrammeId" exact element={<SingleProgrammePage />} />
<Route path="/programme" exact element={<ProgrammeProjectLayoutPage />} />
