...
import seederData from "./intakes.seeder.json";
...
const IntakesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(IntakesSeederDialogComponent);
