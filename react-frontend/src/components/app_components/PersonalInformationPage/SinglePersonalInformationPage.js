  ...
  const copyPageLink = () => {
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            ...
            <div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">FullName</label><p className="m-0 ml-3" >{_entity?.fullName}</p></div>
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">FirstName</label><p className="m-0 ml-3" >{_entity?.firstName}</p></div>
...
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">Student with SpecialConditions</label><p className="m-0" ><i id="studentwithSpecialConditions" className={`pi ${_entity?.studentwithSpecialConditions?"pi-check": "pi-times"}`}  ></i></p></div>
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">Former Sunway Student</label><p className="m-0" ><i id="formerSunwayStudent" className={`pi ${_entity?.formerSunwayStudent?"pi-check": "pi-times"}`}  ></i></p></div>
