...
const pTemplate0 = (rowData, { rowIndex }) => <p >{rowData.schoolName}</p>
  ...
  const handleHideDialog = () => {
    ...
    return (
        ...
        />
<Column field="schoolName" header="SchoolName" body={pTemplate0} filter={selectedFilterFields.includes("schoolName")} hidden={selectedHideFields?.includes("schoolName")}  sortable style={{ minWidth: "8rem" }} />
