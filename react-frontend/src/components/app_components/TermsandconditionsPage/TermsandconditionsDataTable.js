...
const tickTemplate1 = (rowData, { rowIndex }) => <i className={`pi ${rowData.Agree?"pi-check": "pi-times"}`}  ></i>
...
<Column field="Agree" header="Agree" body={tickTemplate1} filter={selectedFilterFields.includes("Agree")} hidden={selectedHideFields?.includes("Agree")}  style={{ minWidth: "8rem" }} />
