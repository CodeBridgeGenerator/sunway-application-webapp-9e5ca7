...
import seederData from "./programme.seeder.json";
...
const ProgrammeSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ProgrammeSeederDialogComponent);
