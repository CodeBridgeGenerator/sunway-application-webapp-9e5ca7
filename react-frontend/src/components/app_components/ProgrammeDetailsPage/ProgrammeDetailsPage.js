...
const ProgrammeDetailsPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            ...
            .find({ query: { $limit: 10000 , name : urlParams.singleUsersId ,campus : urlParams.singleCoursesId ,location : urlParams.singleCoursesId ,programmeLevel : urlParams.singleCoursesId ,programme : urlParams.singleCoursesId ,intake : urlParams.singleCoursesId  , $populate : [
                {
                path: "createdBy",
                service: "users",
                select: ["name"],
